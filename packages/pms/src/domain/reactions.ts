...
/**
 * The five answer kinds Fabro accepts. Copied from ax's play-answer domain at
 * the PMS/Alexandria split (copy-don't-share ruling) — PMS drives its own
 * gates and must not import AX source as its runtime interface.
 */
