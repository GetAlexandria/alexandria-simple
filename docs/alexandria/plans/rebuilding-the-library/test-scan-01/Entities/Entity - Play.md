...
## WHAT
_Stub —_ A named, guided workflow an agent runs — a sequence of [[Entity - Move]]s with a default agent and required knowledge-bank areas. Known plays in code: frame-the-problem, source-assessment.
