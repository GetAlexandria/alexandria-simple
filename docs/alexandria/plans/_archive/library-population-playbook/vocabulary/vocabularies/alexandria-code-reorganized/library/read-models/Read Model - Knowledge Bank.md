...
## WHERE
_Stub —_ Surfaced at `/raven/knowledge-bank`; each subject is an [[Aggregate - Area]] that, once banked, yields [[Aggregate - Atomic Card]]s. Owned by [[Agent - Raven]].
...
## HOW
_Stub —_ Each subject carries a status (available→in_progress→ready_for_atomization→banked→locked) and an optional frozen [[Aggregate - Source of Truth]].
