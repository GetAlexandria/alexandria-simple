...
altLabels: ["atomic card", "AtomicCard", "Library Card", "LibraryGraphCard", "card", "node"]
category: [Entities]
...
## WHERE
_Stub —_ The output end of the knowledge pipeline; becomes a [[Aggregate - Atomic Card]] node in the [[Read Model - Library]]; categorized by the product's own card taxonomy.
...
## WHEN
_Stub —_ Produced when a [[Aggregate - Area]] is banked / atomized.
