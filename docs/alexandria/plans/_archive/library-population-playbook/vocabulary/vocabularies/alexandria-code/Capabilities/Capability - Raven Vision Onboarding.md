...
## WHAT
_Stub —_ The capability of co-authoring a product Vision with Raven, one [[Entity - Vision Slot]] at a time, then banking it as canonical knowledge.

## WHERE
_Stub —_ Driven from [[Surface - Raven Vision Onboarding]] and the `ax raven vision slot …` commands; output banks into the Vision [[Entity - Knowledge Bank Area]].
