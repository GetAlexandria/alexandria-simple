...
## WHAT
_Stub —_ The capability of executing a guided [[Entity - Play]] through the factory, optionally detached, producing a tracked [[Entity - Play Run]].
...
## HOW
_Stub —_ `ax run <play-id> [--detach] [--adapter-command …]`; a run bridge streams Fabro stages into the [[Entity - Event Ledger]].
