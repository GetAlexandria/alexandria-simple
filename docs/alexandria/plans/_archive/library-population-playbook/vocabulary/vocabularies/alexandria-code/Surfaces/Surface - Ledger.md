...
## WHERE
_Stub —_ "Ledger" stone in [[Surface - Stone Top Bar]] (currently shown locked/disabled). Reads the [[Entity - Event Ledger]] populated by the [[System - Runtime Event Store]].
