...
## WHAT
_Stub —_ A record of turning source material into a [[Entity - Source of Truth]]: which agent, which template, which source materials, and its lifecycle status.

## WHERE
_Stub —_ Bridges [[Entity - Source Item]] → [[Entity - Source of Truth]] within a [[Entity - Knowledge Bank Area]]; an internal pipeline record more than a user-facing object.
