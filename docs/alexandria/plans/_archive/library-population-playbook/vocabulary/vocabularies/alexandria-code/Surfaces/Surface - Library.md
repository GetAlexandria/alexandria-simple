...
## WHERE
_Stub —_ "Library" stone in [[Surface - Stone Top Bar]]. Renders [[Entity - Library Card]] nodes connected by [[Entity - Library Graph]] edges; cards open in a [[Surface - Card Drawer]]. Routes `/library` and `/library/folders`.
