# Example Release Card (Reference Copy)

> **Status:** This is a verbatim copy of a LifeBuild release card
> (`Release - The Art.md`), preserved here as an example of the release planning
> output format. This shows what a fully planned release card looks like in practice.
...
| [[Experience Goal - Accomplishment]]          | Expressed through art evolution — effort becomes visible |
