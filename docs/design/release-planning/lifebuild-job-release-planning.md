# LifeBuild Release Planning Skill (Reference Copy)

> **Status:** This is a verbatim copy of the LifeBuild-specific release planning skill
> (`lifebuild/.claude/skills/conan/job-release-planning.md`), preserved here as reference
> material for generalizing release planning into Alexandria plugin.
>
> **Do not use this file as a skill.** It contains hardcoded LifeBuild concepts (three
> specific Product Thesis planks, maturity ladders, arc structure). The generalized version
> will live in `skills/conan/job-release-planning.md` once implemented.
...
Source: `docs/alexandria/rationale/product-thesis/Product Thesis - Spatial Visibility.md`
...
Source: `docs/alexandria/rationale/product-thesis/Product Thesis - Superior Process.md`
...
Source: `docs/alexandria/rationale/product-thesis/Product Thesis - AI as Teammates.md`
...
3. **Read the three plank cards** — Always re-read the maturity ladders to anchor ladder positions:
   - `docs/alexandria/rationale/product-thesis/Product Thesis - Spatial Visibility.md`
   - `docs/alexandria/rationale/product-thesis/Product Thesis - Superior Process.md`
   - `docs/alexandria/rationale/product-thesis/Product Thesis - AI as Teammates.md`
...
- Release cards live at: `docs/alexandria/releases/`
- Naming: `Release - [Title].md` (e.g., `Release - The Campfire.md`)
- Product Thesis cards: `docs/alexandria/rationale/product-thesis/Product Thesis - *.md`
- Existing releases: Read all files in `docs/alexandria/releases/` before writing new ones
- Builder journey phases: `docs/alexandria/experience/journeys/Journey - Sanctuary Progression.md`
