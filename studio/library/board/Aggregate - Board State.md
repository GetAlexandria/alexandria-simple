...
- "Stage" lives here; "status" (proving ladder) lives in [[Read-Model - Play Registry]] — deliberately distinct (see Hot Spot H1 in STUDIO-EVENTS.md).
