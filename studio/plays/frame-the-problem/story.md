...
### 1. `pre_fill` — Draft the framing to react to
...
### 2. `review` — React to the draft — give feedback, or approve to finish

Routes besides the golden path: `[R] Revise` → `revise`
