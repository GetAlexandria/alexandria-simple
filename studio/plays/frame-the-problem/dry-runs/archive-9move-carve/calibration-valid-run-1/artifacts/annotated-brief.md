...
Prior bounce items (from runtime/bounce-note.md) resolved:
- Item 1 ("weeks" in Entry 4 Circumstance, strike 2/3): resolved — "Eight weeks" replaced with duration-free phrasing.
- Item 2 ("first" in Unclear section, strike 1/3): resolved — "first-hand" replaced with "direct."
